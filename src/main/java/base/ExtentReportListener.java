...
public class ExtentReportListener {
	...
	String captureScreenShot(Method method, WebDriver driver) {
		/*
		 * Take screenshot instance check folder exist create folder if not exist name
		 * the target screen shot file capture the screenshot file runtime copy/save it
		 * in your local
		 */
		...
		File targetFile = new File(
				System.getProperty("user.dir") + "/screenShot/error_" + method.getName() + Instant.now() + ".png");
		try {
